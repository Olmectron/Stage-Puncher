...
var HexUtils={
getByteArrayFromString: function(s) {
    var b = new Array();
    var last = s.length;
...
getByteArrayFromArrayBuffer:function(fullArray){
    var arreglo=Array.from(new Uint8Array(fullArray));
...
getStringFromByteArray: function(fullArray){
    var hexBig="";
    for(var i=0;i<fullArray.length;i++){
...
var Hex={
START_IMAGE:"FFD8FFE000104A464946",
END_IMAGE_LARGE:"FFD9000000000000000000",
END_IMAGE:"FFD9"
};
